...
import { LuClock as Clock, LuZap as Zap, LuSearch as Search, LuLayoutGrid as LayoutGrid, LuSmartphone as Smartphone } from "react-icons/lu";
...
export const getAnalytics = unstableCache(
...
export const sections = unstable_cache(
  async () => [
...
export const performanceData = unstable_cache(
  async () => [
...
export const conversionData = unstable_cache(
  async () => [
