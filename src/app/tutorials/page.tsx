...
const Page = async ({ searchParams }: Props) => {
  ...
  const response = await fetchAllTutorials({ page, perPage, tutorialType: tutorialType, skillLevel: skillLevel })

  if (response.tutorials.pageInfo && response.tutorials.pageInfo?.offsetPagination?.total) {
    totalPages = Math.ceil(response.tutorials.pageInfo.offsetPagination.total / perPage);
  }
    ...
    <main id="tutorials-page">
      <div className='layout'>
        ...
        <TutorialFilters
          ...
          currentFilters={{ skillLevel: skillLevel || null, tutorialType: tutorialType || null }}
        />
