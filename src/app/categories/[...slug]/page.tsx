              ...
              {posts?.map((post: Post) => (
                <div key={post.key} className="card">
                  {post.postDetails?.headerImage && (
                    <figure className="card__image-wrapper">
                      <Image
                        ...
                        width={
                          post.postDetails.headerImage.node.mediaDetails.width
                        }
                        height={
                          post.postDetails.headerImage.node.mediaDetails.height
                        }
                  ...
                  <div className="card__intro">
                    <Link href={`/blog/${post.slug}`} className="card__heading">
                      {post.title}
                    </Link>
                    {post.postDetails?.description && (
                      <div
                        dangerouslySetInnerHTML={{
                          __html: post.postDetails.description,
                        }}
                  ...
                  <div className="card__footer">
                    <div className="card__comments">
                      <p className="card__text">
                        <HiOutlineChat className="meta__image" size={18} />4
                      </p>
                    </div>

                    <div className="card__calendar">
                      <p className="card__text">
                        <HiOutlineCalendar className="meta__image" size={18} />
