import madeByAGirl from "@/assets/images/cliques/madebya-purple.png"
import angelNumbers from "@/assets/images/cliques/tiny-222.png"
...
export function Cliques() {
  return (
    <div id="cliques">
      ...
      <Link href="https://lovesick.cafe/esoterica/angelnumbers" target="_blank">
        <Image
