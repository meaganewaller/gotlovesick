...
import { RxArrowRight as ArrowRightIcon } from "react-icons/rx";
...
const BentoCard = ({ name, className, background, Icon, description, href, cta }: { name: string; className: string; background: ReactNode; Icon: any; description: string; href: string; cta: string }) => (
  <div
    ...
    className={cn(
      ...
      // light styles
      "bg-zinc-50 [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)]",
      // dark styles
