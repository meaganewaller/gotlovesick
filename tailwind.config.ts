...
function flattenColorPalette(colors: Record<string, any>): Record<string, any> {
  const result: Record<string, any> = {}

  function recurse(currentKey: string, value: any) {
    if (typeof value === "object" && value !== null) {
      for (const key in value) {
        recurse(`${currentKey}-${key}`, value[key])
      }
    } else {
...
//       },
//       backgroundImage: {
//         corkframe: "url('../src/assets/images/corkborder.jpg')",
//         corkboard: "url('/images/bg/cork.jpg')",
//         satin: "url('/images/bg/satin.jpg')",
...
//         griegeGrid: "url('/images/bg/griegegrid.png')",
//         moonPlanets: "url('/images/bg/moonplanets.png')",
...
//         paper: "url('/images/bg/papertexture.gif')",
//         vintagePink: "url('/images/bg/vintagepink.png')",
